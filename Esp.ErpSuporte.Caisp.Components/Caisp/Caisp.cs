...
namespace Esp.ErpSuporte.Caisp.Components.Caisp
{
    public class CaispComponente : BusinessComponent<CaispComponente>, ICaisp
    {
        ...
        public string AnaliseFaturamento(ProcessarAnaliseModel request)
        {
            ...
            Query qDevolucao = new Query(@"SELECT FN_DOCUMENTOS.DATAEMISSAO,
                                        ...
                                        ");
            DateTime date = DateTime.ParseExact(request.Datafim, "dd/MM/yyyy", System.Globalization.CultureInfo.InvariantCulture);//new DateTime(2021, 5, 01); // Exemplo de data
            ...
            foreach (var x in query)
            {
                ...
                AnaliseFaturamento.Fields["PROCESSO"] = x.Devolucao;
